...
class DrawDiagramTest extends TestCase
{
    ...
    public function testNoSemanticStateHasColor(): string
    {
        ...
        $this->assertStringContainsString('s5 [URL="docs/semantic.s5.html" target="_parent" color="red"]', $dot);
        $this->assertStringContainsString('s6 [URL="docs/semantic.s6.html" target="_parent"]', $dot);
